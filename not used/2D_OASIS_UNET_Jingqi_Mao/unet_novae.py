# unet_oasis_seg.py  — plain UNet for OASIS (binary or multi-class) segmentation
...
def _norm_key(name: str) -> str:
    # 'seg_441_slice_0.nii.png' or 'case_441_slice_0.nii.png' -> '441_slice_0.nii.png'
    base = Path(name).name
...
class SegSlicesDataset(Dataset):
    ...
    Masks must be single-channel class IDs. If you have 255 as "ignore", set IGNORE_INDEX=255.
    """
    def __init__(
        self,
...
def main():
    ...
    # Save final model (tag Dice & epochs in filename for convenience)
